...
.controller('itemsCtrl', function($scope,$http,$rootScope,sharedCartService,sharedFilterService) {
  ...
  $scope.loadMore = function() {
   ...
   $scope.addToCart=function(id,image,name,price){  
    ...
    check = cart.add(id,image,name,price,1);
...
.controller('cartCtrl', function($scope,$rootScope,sharedCartService,$ionicPopup,$state) {
